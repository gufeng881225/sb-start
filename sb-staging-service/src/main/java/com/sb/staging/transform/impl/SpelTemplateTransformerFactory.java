 ...
 */
@Component
public class SpelTemplateTransformerFactory implements TransformerFactory {
    @Override
    public Transformer createTransformer(Map<String, Object> properties) {
        return new SpelTemplateTransformer(properties.get("file"));
    }

    @Override
    public boolean supports(Map<String, Object> properties) {
        return "spel".equals(properties.get("type"));
    }
}